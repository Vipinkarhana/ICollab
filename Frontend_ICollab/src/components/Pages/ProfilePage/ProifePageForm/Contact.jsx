        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-auto">
          ...
          <section className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-4">
              <div>
                <label className="block sm:text-xl text-sm font-medium text-gray-700">
                  Email
                </label>
                <input
                  type="email"
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-lg text-gray-600 mb-4">
              In case something goes wrong when you're attending a hackathon
              organized on IrCollab, who’d you like us to reach out to first?
            </p>
            <div className="space-y-4">
              <div>
                <label className="block sm:text-xl text-lg font-medium text-gray-700">
