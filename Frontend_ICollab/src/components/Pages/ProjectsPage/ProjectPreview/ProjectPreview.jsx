...
function ProjectPreview() {
  const sampleData = {
    ...
    text_content:
      "This platform offers a range of services to help you grow. From networking to knowledge-sharing, we provide everything you need to succeed.",
    video: "https://www.youtube.com/embed/dQw4w9WgXcQ" 
  };

  return (
    <div className="w-full sm:w-[90%] md:w-[80%] lg:w-[75%] mt-20 flex flex-col justify-start items-center p-4">
      {/* Main Container */}
