          ...
          <div className="h-full flex flex-col justify-start items-center w-[25%]">
            ...
            <div className="h-[80%] w-full flex justify-evenly items-center gap-1 text-pretty px-2">
              <p>
                ...
                Nostrum magni quos fugit labore eum cumque veritatis dolores
                dolorem vitae molestias. Et sunt asperiores aspernatur delectus,
                perferendis dolor earum aut velit officiis deserunt.
              </p>
            </div>
          </div>
        </div>
