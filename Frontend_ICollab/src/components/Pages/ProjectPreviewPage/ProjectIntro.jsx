...
import { Heart, Eye, Blocks, UserPlus, Github, Linkedin, Globe } from 'lucide-react';
            ...
            <div className='w-full h-[80%] flex items-start justify-center p-2'>
                <div className='h-full flex flex-col justify-start items-center w-[15%] p-2'>
                    <div className='h-28 w-28 rounded-md overflow-hidden'>
                        <img src="https://devfolio.co/_next/image?url=https%3A%2F%2Fassets.devfolio.co%2Fhackathons%2F77e90ba53cec4f1883f1a5d3350f6e82%2Fprojects%2F226d73c18e3148c8854d27868b6188c4%2Fa67a5df8-2e9a-4cfe-a6d0-bae79844512c.jpeg&w=1440&q=75" alt="" />
                    </div>
                </div>
                ...
                <div className='h-full flex flex-col justify-start items-center w-[25%]'>
                    <div className='h-auto w-full flex justify-evenly items-start gap-1 py-2 '>
                        ...
                        <Link to={"/profile/edit"} className="border border-gray-300 rounded-md px-3 py-2 text-purple-700 hover:bg-gray-100 transition-colors text-lg font-semibold">
                            Edit Project
                        </Link>
                    </div>
                    <div className='h-[80%] w-full flex justify-evenly items-center gap-1 text-pretty px-2'>
                        <p>
                            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nostrum magni quos fugit labore eum cumque veritatis dolores dolorem vitae molestias. Et sunt asperiores aspernatur delectus, perferendis dolor earum aut velit officiis deserunt.
                        </p>
                    </div>
                </div>

            </div>
            <PageNavbar tabs={tabs} activeTab={activeTab} setActiveTab={setActiveTab} className='w-auto gap-3 px-2' />
        </div>
    )
}
